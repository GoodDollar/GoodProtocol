...
import { production as coreContracts } from "@gooddollar/goodcontracts/releases/deployment.json";
import { production as stakingContracts } from "@gooddollar/goodcontracts/stakingModel/releases/deployment.json";
import { production as upgradablesContracts } from "@gooddollar/goodcontracts/upgradables/releases/deployment.json";
